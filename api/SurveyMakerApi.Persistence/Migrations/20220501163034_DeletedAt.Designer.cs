...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220501163034_DeletedAt")]
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 13, 30, 34, 34, DateTimeKind.Local).AddTicks(2875))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 13, 30, 34, 31, DateTimeKind.Local).AddTicks(6419))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 13, 30, 34, 33, DateTimeKind.Local).AddTicks(7215))
                        .HasColumnName("created_at");
