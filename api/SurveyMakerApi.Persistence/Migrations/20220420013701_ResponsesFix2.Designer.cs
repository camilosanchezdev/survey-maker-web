...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220420013701_ResponsesFix2")]
    partial class ResponsesFix2
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 19, 22, 37, 0, 786, DateTimeKind.Local).AddTicks(8147))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 19, 22, 37, 0, 785, DateTimeKind.Local).AddTicks(2046))
                        .HasColumnName("created_at");
