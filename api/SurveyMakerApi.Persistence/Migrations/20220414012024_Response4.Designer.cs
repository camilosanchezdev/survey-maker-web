...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220414012024_Response4")]
    partial class Response4
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 13, 22, 20, 24, 333, DateTimeKind.Local).AddTicks(2998))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 13, 22, 20, 24, 331, DateTimeKind.Local).AddTicks(913))
                        .HasColumnName("created_at");
