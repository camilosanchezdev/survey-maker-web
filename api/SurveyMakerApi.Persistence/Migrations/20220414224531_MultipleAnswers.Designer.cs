...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220414224531_MultipleAnswers")]
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 14, 19, 45, 30, 700, DateTimeKind.Local).AddTicks(5044))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 14, 19, 45, 30, 698, DateTimeKind.Local).AddTicks(9257))
                        .HasColumnName("created_at");
