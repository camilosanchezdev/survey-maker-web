...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220422000223_ResponseRefactor2")]
    partial class ResponseRefactor2
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 21, 21, 2, 22, 785, DateTimeKind.Local).AddTicks(2911))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 21, 21, 2, 22, 783, DateTimeKind.Local).AddTicks(7311))
                        .HasColumnName("created_at");
