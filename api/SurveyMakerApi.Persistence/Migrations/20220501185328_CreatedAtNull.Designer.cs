...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220501185328_CreatedAtNull")]
    partial class CreatedAtNull
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 15, 53, 28, 44, DateTimeKind.Local).AddTicks(7525))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 15, 53, 28, 42, DateTimeKind.Local).AddTicks(9761))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 15, 53, 28, 44, DateTimeKind.Local).AddTicks(2249))
                        .HasColumnName("created_at");
