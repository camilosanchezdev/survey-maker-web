...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220430004940_UserCreatedAt")]
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 29, 21, 49, 39, 996, DateTimeKind.Local).AddTicks(1720))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 29, 21, 49, 39, 992, DateTimeKind.Local).AddTicks(7938))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 29, 21, 49, 39, 995, DateTimeKind.Local).AddTicks(5928))
                        .HasColumnName("created_at");
