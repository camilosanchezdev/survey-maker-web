...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220422000045_ResponseRefactor")]
    partial class ResponseRefactor
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 21, 21, 0, 45, 84, DateTimeKind.Local).AddTicks(7456))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 21, 21, 0, 45, 82, DateTimeKind.Local).AddTicks(7697))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.ResponseQuestion", b =>
                {
                    ...
                    b.HasOne("SurveyMakerApi.Persistence.Models.Response", null)
                        .WithMany("ResponseQuestions")
