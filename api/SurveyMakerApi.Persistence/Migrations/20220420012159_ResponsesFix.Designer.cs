...
namespace SurveyMakerApi.Persistence.Migrations
{
    ...
    [Migration("20220420012159_ResponsesFix")]
    partial class ResponsesFix
    {
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Response", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 19, 22, 21, 58, 925, DateTimeKind.Local).AddTicks(8516))
            ...
            modelBuilder.Entity("SurveyMakerApi.Persistence.Models.Survey", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 19, 22, 21, 58, 924, DateTimeKind.Local).AddTicks(1203))
                        .HasColumnName("created_at");
